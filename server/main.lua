...
RegisterServerEvent('wv_shops:buyItem')
AddEventHandler('wv_shops:buyItem', function(itemName, amount, zone)
	local source = source
	...
	if amount < 0 then
		print('wv_shops: ' .. xPlayer.identifier .. ' attempted to exploit the shop!')
		return
	end
